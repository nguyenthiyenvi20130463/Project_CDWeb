...
<div id="common-home">
        ...
        <div id="slideshow0" class="swiper-container">
            <div class="swiper-wrapper">
                <div class="swiper-slide text-center">
                    <a href="#"><img
                            src="Image/image_web/banner1.png"
                            alt="Main-banner1" class="img-responsive" /></a>
                </div>

                <div class="swiper-slide text-center">
                    <a href="#"><img
                            src="Image/image_web/banner2.png"
                            alt="Main-banner2" class="img-responsive" /></a>
                </div>
                <div class="swiper-slide text-center">
                    <a href="#"><img
                            src="Image/image_web/banner3.png"
                            alt="Main-banner2" class="img-responsive" /></a>
                </div>
            </div>
        </div>
    ...
    <div>
        <div class="parallex-banner section-padding overlay-black40 parallex-img bg-fixed parallax"
             data-image-src="Image/image_web/hehe.jpg"
                    ...
                    <div class="col-lg-7 parallex-description">
                        <div class="parallex-inner">
                            ...
                            <div class="parallex-inner-descritpion">
                                <p>Những quyển sách cũ là những kho báu vô giá đầy kỷ niệm. Mỗi cuốn sách là một cửa sổ mở ra thế giới của riêng mình, mang lại cho ta những trải nghiệm đặc biệt và những bài học không thể nào quên. Chạm vào những trang sách cũ, như là một cuộc hành trình trở về tuổi thơ, khi mà thế giới dường như còn to lớn và đầy bí ẩn.
                                </p>
                                <p>Hãy để những cuốn sách cũ làm dậy lại trong ta những kí ức, những cảm xúc và những giá trị đích thực. Bởi vì trong thế giới của sách, thời gian không bao giờ làm nhạt nhòa đi giá trị của chúng.                                </p>
