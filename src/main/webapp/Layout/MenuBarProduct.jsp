    ...
    <div class="category-list widget-sidebar">
        ...
        <div class="category-list widget-sidebar">
            <a href="ListProduct?category=matthatlung">
                <h4 class="toggled relative">&nbsp;GIÁO TRÌNH</h4>
            </a>
        </div>
            <div class="category-list widget-sidebar">
            <a href="ListProduct?category=daythatlung">
                <h4 class="toggled relative">&nbsp;SÁCH CHUYÊN MÔN</h4>
            </a>
    </div>
        ...
        <div id="banner0" class="swiper-container">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <a href="index.jsp"><img src="../Image/image_web/banner.jpg" alt="left banner"
                                             class="img-responsive" /></a>
                </div>
            </div>
        </div>
