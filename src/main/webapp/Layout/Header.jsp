                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menulist">
                            <a href="ListProduct?category=thatlung"
                               style="font-size: 16px;" class="dropdown-toggle" aria-expanded="false">SÁCH CŨ</a>
                        </li>
                        <li class="menulist">
                            <a href="ListProduct?category=matthatlung"
                               style="font-size: 16px;" class="dropdown-toggle" aria-expanded="false">SÁCH GIÁO TRÌNH</a>
                        </li>
                        <li class="menulist">
                            <a href="ListProduct?category=daythatlung"
                               style="font-size: 16px;" class="dropdown-toggle" aria-expanded="false">SÁCH CHUYÊN MÔN</a>
                        </li>
                        <li class="menulist"><a
            ...
            <div class="header-search">
                ...
                <div id="mahardhiSearch" class="input-group mahardhi-search">
                    <select name="category_id" class="form-control input-lg">
                        ...
                        <option value="2">Sách giáo trình</option>
                        <option value="1">Sách chuyên môn</option>
                    </select>
