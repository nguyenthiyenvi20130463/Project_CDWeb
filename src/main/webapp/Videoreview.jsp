    ...
    <div id="content" class="col-sm-9">
      ...
      <div class="blog-layout product-list blog-category clearfix">
        <div class="product-thumb blog-block clearfix">
          <h3 style="text-align: center;">Động lực thực sự đến từ đâu? Sách Nhà Giả Kim </h3>
          <div style="text-align: center;"><iframe id="_ytid_87190" width="560" height="315"
                                                   src="https://youtu.be/yZrvuX2rrNk?si=kr1ZzkSiRjltpZuC" title="YouTube player"
      ...
      <div class="blog-layout product-list blog-category clearfix">
        <div class="product-thumb blog-block clearfix">
          <h3 style="text-align: center;">Một việc cả đời mà bạn đã đối xử ra sao? Sách Sao chúng ta lại ngủ </h3>
          <div style="text-align: center;"><iframe width="560" height="315"
                                                   src="https://youtu.be/8gBf8x0X4MA?si=Yaow-qqZKh-tGd7K" title="YouTube video player"
                                                   frameborder="0"
                                                   allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
